            ...
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date"><a href="{{ url('/author') }}/{{ $hot_news->creator->id }}">
                            {{ $hot_news->creator->name }}</a>,
           ...
           @foreach($top_viewed as $item)
             <div class="col-md-5" style="margin-bottom: 3%">
                <div class="feature_static_wrapper">
                    ...
                    <!-- feature_article_img -->
                    <div class="feature_article_inner">
                        <div class="tag_lg purple"><a href="{{ url('/details') }}/{{ $item->slug }}">Top Viewed</a></div>
                        <div class="feature_article_title">
                            <h1><a href="{{ url('/details') }}/{{ $item->slug }}" target="_self">{{ str_limit( $item->title,25,'..' ) }} </a></h1>
                        </div>
                        <!-- feature_article_title -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="top_article_img">
                                    <a href="{{ url('/details') }}/{{ $item->slug }}"><img class="img-responsive"
                                      src="{{ asset('post') }}/{{ $item->list_image }}" alt="feature-top">
                                    </a>
                                </div>
                                <!----top_article_img------>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="category_article_title">
                                    <h2><a href="{{ url('/details') }}/{{ $item->slug }}" target="_self">
                                     {{ $item->title }}</a></h2>
                                </div>
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="{{ url('/details') }}/{{ $item->slug }}">{{ $item->title }}</a>
                                    ...
                                    {{ date('j F -y',strtotime($item->created_at)) }}</a>,  by:
                                    <a href="{{ url('/author') }}/{{ $item->creator->id }}">{{ $item->creator->name }}</a>
                                 </span>
