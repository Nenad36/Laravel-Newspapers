    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="{{ url('/back/permission') }}"> <i class="menu-icon fa fa-lock"></i>Permissions </a>
                </li>
                @endpermission
                ...
                @permission(['Permission Update','All'])
                <li>
                    <a href=" {{ url('/back/author') }} "> <i class="menu-icon fa fa-book"></i>Authors </a>
                </li>
                @endpermission

                @permission(['Category List','All'])
                <li>
                    <a href=" {{ url('/back/categories') }} "> <i class="menu-icon fa fa-book"></i>Categories </a>
                </li>
                @endpermission
